...
1. **标题格式**：《作品名》：一个吸引人的副标题，你准备好了吗？

2. **开篇**：
   - 插入图片：![电影海报](IMAGE_PLACEHOLDER)
   - 用一句经典台词或金句开头，加引号
   - 简短解释这句话的意义
   - 简介作品的核心主题
...
7. **📁 网盘资源分享**：
   - 如果有有效链接：[点击获取高清资源]({downloadLink})
   - 如果没有链接：资源链接将在后续更新中提供
...
请按JSON格式返回：
{
  "title": "《作品名》：副标题，你准备好了吗？",
  "excerpt": "包含导演、核心主题、视觉特色和资源分享的50-80字摘要",
  "content": "完整的影评文章markdown内容",
  "tags": ["相关标签"],
