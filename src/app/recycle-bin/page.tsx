      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mt-6 bg-blue-50 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            <li>• <strong>恢复</strong>：将文章从回收站恢复到正常状态，重新在网站上显示</li>
            <li>• <strong>永久删除</strong>：彻底删除文章，无法恢复</li>
            <li>• <strong>清空回收站</strong>：一次性永久删除所有回收站中的文章</li>
            <li>• 建议定期清理回收站，避免占用过多存储空间</li>
          </ul>
        </div>
      </div>
    </div>
